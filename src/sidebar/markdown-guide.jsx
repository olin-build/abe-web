  ...
  <div className="markdown-guide">
    ...
    <div className="markdown-guide-section-container">
      ...
      <div className="markdown-guide-section">
        ...
        <p>
          Currently images must be hosted elsewhere. If you need to upload your photo somewhere, put
          it on Google Drive or Dropbox and use the public link to the file.
        </p>
      </div>
      <div className="markdown-guide-section">
        <span className="markdown-guide-section-title">Lists</span>
        <p>
          Indent each list item with <strong>two spaces</strong>, followed by an asterisk, number,
          or letter, and then another space.
        </p>
